...
static void intro_entities(void)
{
	...
	win_center_print(win.buf, "XTux", i, 2, "white");
	i += 32;
	win_center_print(win.buf, "a game by", i, 2, "white");
	i += 32;
	win_center_print(win.buf, "David Lawrence", i, 2, "white");
	i += 32;
	win_center_print(win.buf, "&", i, 2, "white");
	i += 32;
	win_center_print(win.buf, "James Andrews", i, 2, "white");
	i += 32;
	win_update();
	delay(M_SEC * 3);
